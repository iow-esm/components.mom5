...
! www.ergom.net
!
! Model Version: 2.00a1, code generation date: 2017-Feb-03 09:08 
!----------------------------------------------------------------
...
module generic_ERGOM
  ...
  character(len=128) :: version=&
         '$Id: generic_ERGOM.F90,v 2.00a1 2017-Feb-03 09:08 Baltic Sea Exp $'
...
# endif
             ...
             do while (cgt_timestep .gt. 0.0)
                ...
                p_cya_mort_det_diff = (t_cya*r_pp_mort*(r_cya_mort_diff*theta(cgt_diffusivity-r_cya_mort_thresh)))*lim_t_cya_15
